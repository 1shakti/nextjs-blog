...
const AuthModal:FC<AuthModalProps> = () => {
    ...
    return (
        <>
            <div className='absolute w-full h-full top-0 left-0 bg-black opacity-60 flex items-center justify-center'></div>
            <div className='absolute w-full sm:w-[450px] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex items-center justify-center'>
                ...
                <div className=' relative rounded-lg w-full bg-gradient-to-b from-brand-orange t0-slate-900 mx-6'>
